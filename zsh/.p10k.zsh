# Generated by Powerlevel10k configuration wizard on 2022-10-11 at 19:52 UTC.
...
# left frame, green-ornaments, compact, concise, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      '*prod*|*prd*'  PROD    # These values are examples that are unlikely
